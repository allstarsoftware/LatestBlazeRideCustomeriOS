        ...
        [afn getDataFromPath:FILE_PAYMENT_TYPE withParamData:dictParam withBlock:^(id response, NSError *error)
         {
             ...
             if (response)
             {
                 ...
                 {
                     UIAlertView *alert =[[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"ERROR",[prefl objectForKey:@"TranslationDocumentName"],nil) message:[response valueForKey:@"error"] delegate:self cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
                     [alert show];
                 }
             }
         }];
...
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:nil message:NSLocalizedStringFromTable(@"CANCEL_REQUEST",[prefl objectForKey:@"TranslationDocumentName"],nil) delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"No", [prefl objectForKey:@"TranslationDocumentName"],nil) otherButtonTitles:NSLocalizedStringFromTable(@"Yes", [prefl objectForKey:@"TranslationDocumentName"],nil), nil];
    alert.tag=200;
    [alert show];
...
- (IBAction)promoApplyBtnPressed:(id)sender
{
    ...
    {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:Nil message:NSLocalizedStringFromTable(@"Please Promo", [prefl objectForKey:@"TranslationDocumentName"],nil) delegate:self cancelButtonTitle:nil otherButtonTitles:NSLocalizedStringFromTable(@"OK",[prefl objectForKey:@"TranslationDocumentName"],nil), nil];
        [alert show];
    }
}
