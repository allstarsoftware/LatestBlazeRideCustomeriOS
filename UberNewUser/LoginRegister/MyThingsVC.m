    ...
    [afn getDataFromPath:FILE_THING withParamDataImage:dictParam andImage:self.imgMyThing.image withBlock:^(id response, NSError *error)
     {
        ...
        {
            UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"" message:NSLocalizedStringFromTable(@"THING_SUCCESS",[prefl objectForKey:@"TranslationDocumentName"],nil) delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"OK",[prefl objectForKey:@"TranslationDocumentName"],nil) otherButtonTitles:nil, nil];
            [alert show];
            [self performSegueWithIdentifier:SEGUE_ADD_PAYMENT sender:self];
        }
        else
        {
            UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"" message:NSLocalizedStringFromTable(@"THING_FAIL",[prefl objectForKey:@"TranslationDocumentName"],nil) delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"OK",[prefl objectForKey:@"TranslationDocumentName"],nil) otherButtonTitles:nil, nil];
            [alert show];
        }
