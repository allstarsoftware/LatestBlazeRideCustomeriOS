...
NSString * const StripePublishableKey = @"pk_live_mhs5FU3B8DtQ1MlnxzMuFQof"; // TODO: replace nil with your own value
...
NSString *const SEGUE_TO_PRIVACY=@"segueToPrivacy";
